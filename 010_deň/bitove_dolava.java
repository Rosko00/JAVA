 ...
 */
/* byte result = (byte) (a << 2); - operácia posun doľava (a << 2) posunie všetky bity čísla a o 2 pozície doľava. 
 * Výsledné číslo bude väčšie (každý posun doľava zdvojnásobí hodnotu čísla). Pretože výsledok operácie je typu int, 
