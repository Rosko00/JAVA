 ...
 */
/* byte result = (byte) (a ^ b); - operácia XOR (a ^ b) vykoná bitovú exkluzívnu disjunkciu medzi číslami a a b. 
 * To znamená, že každý bit výsledku bude 1, ak jeden z príslušných bitov v a alebo b je rovný 1, ale nie obidva, 
 * inak bude bit výsledku 0. 
 */
 ...
 * vypíše číslo ako 8-bitové binárne číslo a replace(' ', '0') 
 * zabezpečí, že medzery sú nahradené nulami. 
 */
